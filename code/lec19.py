...
class Employee(Person):
    ...
    def salary_change(self, n):
        ...
        newSalary = self.salary + n
        if newSalary < 0:
          self.salary_track.append(0)
          return 0
        else:
          self.salary_track.append(newSalary)
          return newSalary
    ...
    def past_salary_freq(self):
        ...
        salary_freq = {}
        for s in self.salary_track:
          if s not in salary_freq:
            salary_freq[s] = 1
          else:
            salary_freq[s] += 1
        return salary_freq
